...
namespace ResourceMonitor.Game_Items
{
    ...
    */
    public static class ResourceMonitorScreenLarge
    {
        ...
        public const string NICE_NAME = "Resource Monitor (Large)";
        ...
        {
            ResourceMonitorScreenGeneric.Register(CLASS_ID, NICE_NAME, DESCRIPTION, ICON_FILE_NAME, INGREDIENTS_REQUIRED, SCALE, isLarge: true);
        }
    }
}
